...
class Player extends events_1.EventEmitter {
    ...
    join(channelId, { deaf = false, mute = false } = {}) {
...
Player.prototype.setVolume = (0, util_1.deprecate)(Player.prototype.setVolume, "Player#setVolume: use setFilters instead");
Player.prototype.setEqualizer = (0, util_1.deprecate)(Player.prototype.setEqualizer, "Player#setEqualizer: use setFilters instead");
